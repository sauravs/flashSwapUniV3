   ...
   //console.log('sushipoolAddress', sushipoolAddress);
    ...
    //   });        
     ...
     //////////////////////////////////////////////////////////////////FETCH PRICES///////////////////////////////////////////////////////////
       ...
       const reserves = await sushipoolAddressContract.getReserves();
       const reserve0 = reserves.reserve0;
       const reserve1 = reserves.reserve1;

       console.log('reserves',reserve0.toString(),reserve1.toString());

      const calculatePrice_sushi = Big(reserve0).div(Big(reserve1)).toString();

      console.log('calculatePrice_sushi' , calculatePrice_sushi);
